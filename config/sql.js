...
module.exports = {
    ...
    cateProduct : "SELECT * FROM product where category=? and state = 'y'",
    ...
    workRoomList : 'Select * from work where private = 1',
    myworkRoomList : 'Select * from work where sellerId = ? or participants like ?',
